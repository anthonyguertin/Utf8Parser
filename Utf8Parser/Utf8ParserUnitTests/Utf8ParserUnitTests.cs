...
namespace Utf8ParserUnitTests
{
    [TestClass]
    public class Utf8ParserUnitTests
    {
...
/*
expected:
this is a test key for unit testing which should have multiple lines wherever that utf8 file newline(s) are there should be a word wrap this may be the next line or it may not.This 
 is a line break before the 3rd line would've automatically been created because of the length of the previous line.

actual:
this is a test key for unit testing which should have multiple lines wherever that utf8 file newline(s) are there should be a word wrap this may be the next line or it may not. This is a line break before the 3rd line would've automatically been created because of the length of the previous line.
